...
class OnPluginStartEventListener : AbstractMessageEventListener(TEAM_FORTRESS_2, "NEONSM_ON_PLUGIN_START") {

    override fun getRawString(u: ChannelDocument): String? = u.teamFortress2.onPluginStart
}
