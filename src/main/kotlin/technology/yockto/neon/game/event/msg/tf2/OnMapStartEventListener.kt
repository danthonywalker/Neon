...
class OnMapStartEventListener : AbstractMessageEventListener(TEAM_FORTRESS_2, "NEONSM_ON_MAP_START") {

    override fun getRawString(u: ChannelDocument): String? = u.teamFortress2.onMapStart
}
